# Apollo-Documentation-Alex-2949-Final

<h1 id="overview"><strong>22222Overview</strong></h1>
...
<p>Each file inside the&nbsp;<a title="https://github.com/searchdiscovery/mohawk-flooring-dl-spec/blob/main/events" href="https://github.com/searchdiscovery/mohawk-flooring-dl-spec/blob/main/events" target="_blank" rel="noopener">events</a>&nbsp;folder corresponds to a single use case or site event that needs to be implemented. These events are leveraged to trigger tracking rules in the tag management tool of choice and share data with the analytics reporting tool.</p>
...
<p>For any questions or comments, please contact&nbsp;apUser-1634720998152-54@sdi.com.</p>